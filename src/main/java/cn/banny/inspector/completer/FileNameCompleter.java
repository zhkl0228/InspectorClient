...
public class FileNameCompleter
    implements Completer, FileFilter
{
    ...
    public FileNameCompleter(InspectorClient inspector, File homeDir, String... extensions) {
		super();
	...
	public int complete(String buffer, final int cursor, final List<CharSequence> candidates) {
		if(homeDir == null || (inspector != null && !inspector.isConnected())) {
			return -1;
		}
        ...
        File[] entries = dir == null ? new File[0] : dir.listFiles(this);
	...
	public boolean accept(File pathname) {
        return Arrays.binarySearch(extensions, FilenameUtils.getExtension(pathname.getName())) >= 0;
	}
}
